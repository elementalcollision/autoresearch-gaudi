...
> Original guide for CUDA; this version updated for Intel Gaudi 3 context.
...
3. **Optimal hyperparameters differ by dataset.** Don't assume parameters transfer.
