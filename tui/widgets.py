...
class HardwarePanel(Static):
    """Displays Intel Gaudi 3 hardware info and memory usage."""
    ...
    def _refresh_content(self) -> None:
        ...
        lines.append(Text(f"  Memory: {total_gb:.0f} GB HBM2e", style="white"))
        ...
        devices = hw.get('device_count', 0)
        lines.append(Text(f"  TPCs: {cores}  |  Devices: {devices}", style="white"))
...
class ExperimentStatusPanel(Static):
    ...
    def _refresh_content(self) -> None:
        ...
        # Status line
        status_icon = {
            "idle": "o", "initializing": ">", "baseline": ">",
            "thinking": "?", "committing": "*", "training": ">",
            "evaluating": "#", "stopped": "x",
        }.get(self._status, "-")
        lines.append(Text(
